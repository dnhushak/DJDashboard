...
public class SAXParserExample extends DefaultHandler {
    ...
    private static String LIBRARY_FILE_PATH = "C:\\iTunes Music Library.xml";
    ...
    private boolean foundPlaylists = false;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if(foundPlaylists)
        {
        	if("key".equals(previousTag) && "String".equalsIgnoreCase(qName) && "Name".equalsIgnoreCase(previousTagVal))
        	{
        ...
        {
        	if("key".equals(previousTag) && "Playlists".equalsIgnoreCase(previousTagVal) && "dict".equalsIgnoreCase(qName))
        	{
        		foundPlaylists = true;
        	}
        }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException 
    {
        ...
        if(foundPlaylists)
        {
             ...
             {
                     tempPlaylist.setID(Integer.parseInt(tempVal));
             }
             else if (previousTagVal.equalsIgnoreCase("Playlist Persistent ID") && qName.equals("string"))
             {
                     tempPlaylist.setPersistentID(tempVal);
             }
             else if (previousTagVal.equalsIgnoreCase("Track ID") && qName.equals("integer"))
             {
            	tempTrack = new Track();
             	tempTrack.setITL(Integer.parseInt(tempVal));
             	tempPlaylist.getTracks().add(tempTrack);
             }
        }
