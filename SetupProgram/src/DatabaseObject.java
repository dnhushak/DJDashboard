...
public class DatabaseObject {
	...
	public void buildPHPConstants(String path){
		StringBuilder sb = new StringBuilder();
		sb.append("<?php\n");
		sb.append("/**\n\tThis file was automatically generated by the DJDashboard Setup program\n\tWritten by Robert Clabough\n\n");
		sb.append("\tit is to be placed in the Web Server under the php folder.\n**/\n");
