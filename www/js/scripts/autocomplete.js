...
$(document).ready(function(){
	...
	updatePlayID = function(playID, trackID){
		$.ajax({
	...
	getTrackDataForUpdate = function(trackID, songIndex){
	    $.ajax({
	        type: "GET",
	        url: "../php/scripts/getTrackData3.php",
	        ...
	        songID = songInfo['idtrack'];
	        $('#input-track').val(songInfo['TrackName']);
	        artistID = songInfo['idartist'];
	        $('#input-artist').val(songInfo['ArtistName']);
	        albumID = songInfo['idalbum'];
